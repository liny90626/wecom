...
> 最后更新：2026-08-26（`2.7.260-15` 构建完成，待真机验证后发布）。新会话开工前先读本文件、`README.md`、`changelog/README.md` 与最新版本简报。

## 1. 当前状态

- **`2.7.260-15` 已构建但未打 tag、未推远端**——`-14` 冒烟失败后的收口，等真机验证通过再发布，详见第 2t 节。
