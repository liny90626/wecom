...
- **未发布**：分支 `fix/v150-time-driven-long-task-feedback`（基于 `main`，5 个提交），根治「零产出长任务全程静默」，见第 2d 节。**尚未打包 / 打 tag / 改 README 与 changelog / 推远端**，等待批准。
