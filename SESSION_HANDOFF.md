...
> 最后更新：2026-08-07（`2.7.260-6` 发布收口）。新会话开工前先读本文件、`README.md`、`changelog/README.md` 与最新版本简报。
...
- **真机（企微网关/客户端）验证仍未做**：`2.7.260-6` 发布后除继续观察结构化进度、8 分钟心跳、相邻气泡、复用 `req_id`、迟到 ACK 与 emoji 边界外，还需确认多个 commentary item 完全同文时只显示一次、后续分化更新仍能出现。
