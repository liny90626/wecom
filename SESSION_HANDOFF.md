...
- 当前正式版本：**`2.7.260-11`**，发布标签 `released/2.7.260-11`，包 `yanhaidao-wecom-2.7.260-11.tgz`（232,589 bytes；解包 1,056,407 bytes；139 文件；npm shasum `3e31e71a8702ba4d120825f50fcf484b85931bab`；SHA-256 `9bb6c07ecaca45315400936319e24cb5409e8d27fb6f7aa16813a47b61130730`）。收口「思考块过长导致回复失败」（wire 未安全化 + 头部截断静音 + 与正文抢预算）与「长任务过程仍在丢失、收尾记录令人困惑」（6→8 分钟盲区、首推重复、取消记录推送）；消息上限按官方 20480 字节调到约 75%；新增工具阶段的沉默看门狗。详见第 2p 节。
