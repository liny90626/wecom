...
/**
 * 单帧 stream.content 的实际预算（UTF-8 字节）。官方上限 20480 字节，留 25% 给
 * markdown 转义与多字节边界，与 2.7.x 现网验证值一致。装不下的正文改走主动推送。
 */
export const STREAM_FRAME_MAX_BYTES = 15_360;

/** 主动推送（sendMessage markdown）单条正文的字符上限，2.7.x 现网验证值。 */
export const ACTIVE_PUSH_CHUNK_CHARS = 3_500;
